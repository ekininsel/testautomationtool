...
public class MethodPrinter {
	...
	private static void classGenerator() {
		TypeSpec generatedTestClass = TypeSpec.classBuilder("GeneratedTestClass").addModifiers(Modifier.PUBLIC).build();

		JavaFile javaFile = JavaFile.builder("junit.generate.test", generatedTestClass)
				.addFileComment("AUTO_GENERATED BY JavaPoet").build();
